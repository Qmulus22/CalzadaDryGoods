...
<script>
    ...
    let isExpanded = false; // Start with the POS not expanded
    ...
    function toggleIcon(event) {
        ...
        if (isExpanded) {
            // Collapse state: go back to admin menu
            icon.src = 'icons/expand.ico'; // Show expand icon
            link.href = 'admin_menu.php?page=POS'; // Set link to admin page
            window.location.href = link.href; // Redirect
        } else {
            // Expand state: go to POS page
            icon.src = 'icons/collapse.ico'; // Show collapse icon
            link.href = 'POS.php'; // Set link to POS page
            window.location.href = link.href; // Redirect
        }
